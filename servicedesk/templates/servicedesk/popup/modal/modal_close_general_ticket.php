                                  ...
                                  <form id="edit_form" method="POST">
                                    ...
                                    <div class="form-row col-md-12">
                                     ...
                                     <div class="form-row col-md-12">
                                        ...
                                        <div class="form-group col-md-12">
                                            <label>Status</label>
                                            <input class="form-control" name="" type="text" id="Status" value="<?php echo $value->Status; ?>" > 
                                        </div>
                                        <input name="Status" type="hidden" id="st1" value="Closed" >
                                    </div>

                                    <div class="form-row col-md-12">
                                        
                                    
                                        <button type="submit" class="btn btn-success col-md-12" style="text-align: center; width:100%;" >Close</button>
...
$('#edit_form').submit( function (ev) {
   if (confirm("Have you notified the customer?")) {
...
*/
      $.ajax({
      type: "POST",
      url: '<?php echo base_url(); ?>index.php/Popup/general_close_complain_action',
