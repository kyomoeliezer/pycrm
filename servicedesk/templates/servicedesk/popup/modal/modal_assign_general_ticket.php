                                  ...
                                  <form id="edit_form" method="POST">
                                    ...
                                    <div class="form-row col-md-12">
                                     ...
                                     <div class="form-row col-md-12">
                                        ...
                                        <input name="Status" type="hidden" id="number" value="Assigned" >
                                        <div class="form-group col-md-12">
                                            <label>Responsible</label>
                                            <select name="ResponsibleId" class="form-control select2" id="Status" required="true">
                                    ...
                                    <div class="form-row col-md-12">
                                        ...
                                        <button type="submit" class="btn btn-success col-md-12" style="text-align: center; width:100%;" >Assign</button>
...
*/
      $.ajax({
      type: "POST",
      url: '<?php echo base_url(); ?>index.php/Popup/general_assign_complain_action',
